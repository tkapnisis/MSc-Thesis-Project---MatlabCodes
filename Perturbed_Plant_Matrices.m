function [A_u,B_u,Bd_u,C_u,D_u,Dd_u] = Perturbed_Plant_Matrices(param,A_s,B_s,Bd_s,C_s,D_s,Dd_s)
...
theta_s_f0 = param.theta_s_f0;  % Operating angle of servo motors for the fore hydrofoil
theta_s_ap0 = param.theta_s_ap0; % Operating angle of servo motors for the aft port hydrofoil
theta_s_as0 = param.theta_s_as0; % Operating angle of servo motors for the aft starboard hydrofoil
