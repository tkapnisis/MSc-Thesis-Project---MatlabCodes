...
[A_u,B_u,Bd_u,C_u,D_u,Dd_u] = Uncertain_Plant(param,A_s,B_s,Bd_s,C_s,D_s,Dd_s);
...
%%
save('Linear_State_Space_3DOF_Un.mat')
% ,'A_u_samples','B_u_samples','Bd_u_samples',...
%                                       'G','Gd','Gp','Gd_p','Gp_s','Gd_p_s')