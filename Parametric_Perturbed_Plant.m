...
delta_s_f0 = param.delta_s_f0;  % Operating angle of servo motors for the fore hydrofoil
delta_s_ap0 = param.delta_s_ap0; % Operating angle of servo motors for the aft port hydrofoil
delta_s_as0 = param.delta_s_as0; % Operating angle of servo motors for the aft starboard hydrofoil
