...
U=4;         %[m/s]      Hydrofoil speed in x direction
...
Dclf_O_Dalpha=4.205;%0.06*(360/(2*pi));       %From Flyingfish documentation Figure 2-7  Converted to 1/rad
Dcla_O_Dalpha=4.205;%0.06*(360/(2*pi));       %From Flyingfish documentation Figure 2-7
Dcdf_O_Dalpha=0.380;%0.00375*(360/(2*pi));    %From Flyingfish documentation Figure 2-7
Dcda_O_Dalpha=0.380;%0.00375*(360/(2*pi));    %From Flyingfish documentation Figure 2-7
