...
% load('Uncertainty_Approximation_Add')
...
sys11 = series((1 + W_O_Delta.wd11),G(1,1));
sys12 = series((1 + W_O_Delta.wd12),G(1,2));
sys13 = series((1 + W_O_Delta.wd13),G(1,3));
sys21 = series((1 + W_O_Delta.wd21),G(2,1));
sys22 = series((1 + W_O_Delta.wd23),G(2,2));
sys23 = series((1 + W_O_Delta.wd23),G(2,3));
sys31 = series((1 + W_O_Delta.wd31),G(3,1));
sys32 = series((1 + W_O_Delta.wd32),G(3,2));
sys33 = series((1 + W_O_Delta.wd33),G(3,3));
...
%%
weight11 = W_O_Delta.wd11;
weight12 = W_O_Delta.wd12;
weight13 = W_O_Delta.wd13;
weight21 = W_O_Delta.wd21;
weight22 = W_O_Delta.wd22;
weight23 = W_O_Delta.wd23;
weight31 = W_O_Delta.wd31;
weight32 = W_O_Delta.wd32;
weight33 = W_O_Delta.wd33;
...
Sum_y_un11 = sumblk('y_un_11 = u1 + uDelta11',1);
Sum_y_un11 = sumblk('y_un_12 = u2 + uDelta11',1);
Sum_y_un11 = sumblk('y_un_12 = u3 + uDelta11',1);
...
%%
figure
bodeplot(Gp_add(2,1),G(2,1),W_A.w21,bode_opts)
