...
param.C_L0 = ureal('C_L0',-3.64e-4,'Percentage',[-5,5]);        % y-intercept of the linear approximation for CL [-]
param.C_La = ureal('C_La',3.925,'Percentage',[-5,5]);        % Slope of the linear approximation for CL [-]
