...
G_diag = append(G(1,1),G(2,1),G(3,1),G(1,2),G(2,2),G(3,2),G(1,3),G(2,3),G(3,3));
...
Paug = connect(G,W_A_ref,sup_mat,Wp,Wu,Wr,Wd,Sum_err,inputs,outputs);
